...
# this will print it the while loop didnt run (i.e. guess no longer less than 10, max number of guesses allowed)
print('Sorry, you reached the maximum number of attempts.')
